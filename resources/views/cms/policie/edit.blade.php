            ...
            <form id="create-form">
                <div class="card-body">
                            ...
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="language"
                                    ...
                                    @foreach ($languages as $language)
                                        <option value="{{$language->id}}" @selected($policieTranslation->language_id == $language->id)>{{$language->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="title" placeholder="{{__('cms.title')}}"
                                value="{{$policieTranslation->title}}" />
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9" >
                            <textarea type="text" class="form-control" id="body"  placeholder="{{__('cms.body')}}"  rows="4" cols="5" >{{$policieTranslation->body}}</textarea>
...
<script>
    function performEdit(){
        ...
        update('/cms/admin/policies/translations/{{$policieTranslation->id}}', data, '/cms/admin/policies');
    }
</script>
@endsection
