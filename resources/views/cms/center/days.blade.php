            ...
            <form id="create-form">
                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col-9">
                            <button type="button" onclick="performStore()" id="btnStore" class="btn btn-primary mr-2">{{
                                __('cms.save') }}</button>
...
<script>
    var image = new KTImageInput('kt_image_5');
        ...
        function getDataForLang(lang) {
            ...
            axios.get('/cms/admin/centers/get-daywork/' + lang).then(function(response) {
        ...
        function performStore() {
            ...
            store('/cms/admin/centers/daywork/{{$center->id}}', formData);
        }
</script>
@endsection