            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                <thead>
                    <tr class="text-uppercase">
                        ...
                        <th style="min-width: 150px">{{__('cms.question')}}</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$faq->translations->first()?->qs
                                ?? ''}}</a>
                        </td>
                        <td>
                            <a href="#" data-toggle="modal" data-target="#sports_{{$faq->id}}_translations"
                                class="btn btn-light-primary font-weight-bolder font-size-sm">({{$faq->translations_count}})</a>
                            <div class="modal fade" id="sports_{{$faq->id}}_translations" tabindex="-1" role="dialog"
                                aria-labelledby="sports_{{$faq->id}}_translations" aria-hidden="true">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span
                                                                class="text-info font-weight-bolder d-block font-size-lg">{{$translation->qs}}</span>
                                                        </td>
                                                        <td>
                                                            <span
                        ...
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$faq->translations->first()?->answer
                                ?? ''}}</a>
                        </td>
