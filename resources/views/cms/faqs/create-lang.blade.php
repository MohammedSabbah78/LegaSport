        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <form id="create-form">
                <div class="card-body">
                    ...
                    <div class="form-group row mt-4">
                        <label class="col-3 col-form-label">{{__('cms.questions')}}:</label>
                        <div class="col-9">
                            <input type="text" class="form-control" id="qs" placeholder="{{__('cms.questions')}}" />
                            <span class="form-text text-muted">{{__('cms.questions')}}</span>
                        </div>
                    </div>
...
formData.append('qs',document.getElementById('qs').value);
...
if(id == null) {
    ...
    store('/cms/admin/faqs/'+id+'/translation',formData, '/cms/admin/faqs');
    }
