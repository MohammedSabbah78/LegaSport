            ...
            <form id="create-form">
                <div class="card-body">
                            ...
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="language"
                                    ...
                                    @foreach ($languages as $language)
                                        <option value="{{$language->id}}" @selected($mercatoTranslation->language_id == $language->id)>{{$language->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="title" placeholder="{{__('cms.title')}}" value="{{$mercatoTranslation->title}}"/>
...
<script>
    function performEdit(){
        ...
        update('/cms/admin/mercatos/translations/{{$mercatoTranslation->id}}', data, '/cms/admin/mercatos');
    }
</script>
@endsection
