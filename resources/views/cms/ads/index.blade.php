            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$ad->name}}</a>
                        </td>
                        <td>
                            <span
                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$ad->onBoarding->name ??''}}</span>
                        </td>


                        <td>
                            <span
                                class="label label-lg @if($ad->active) label-light-success @else label-light-danger @endif label-inline">{{$ad->active_key}}</span>
                        </td>
                        ...
                        <td class="pr-0 text-right">
                            ...
                            @endcan
                            <a href="{{route('ads.edit',$ad->id)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
                                <span class="svg-icon svg-icon-md svg-icon-primary">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Write.svg-->
