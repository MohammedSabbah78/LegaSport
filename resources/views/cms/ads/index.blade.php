            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                <thead>
                    <tr class="text-uppercase">
                        ...
                        <th style="min-width: 150px">{{__('cms.on_boarding')}}</th>
                        ...
                        <td class="pl-0">
                            <div class="symbol symbol-50 symbol-light mr-4">
                                <span class="symbol-label">
                                    <img src="{{Storage::url($ad->image)}}" class="customImage h-75 align-self-end" alt="">
                                </span>
                            </div>
                        </td>
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$ad->onBoarding->name
                                ??''}}</span>
                        </td>
