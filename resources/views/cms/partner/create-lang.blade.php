...
@section('page-name-small',__('cms.partner'))
            ...
            <form id="create-form">
                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col-9">
                            <button type="button" onclick="performStore({{$partner->id ?? null}})"
...
if(id == null) {
    ...
    store('/cms/admin/partners/'+id+'/translation',formData, '/cms/admin/partners');
    }
