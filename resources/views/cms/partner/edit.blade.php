            ...
            <form id="create-form">
                <div class="card-body">
                            ...
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="language"
                                    ...
                                    @foreach ($languages as $language)
                                        <option value="{{$language->id}}" @selected($partnerTranslation->language_id == $language->id)>{{$language->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="country" title="Choose one of the following..."
                                    ...
                                    <option value="{{$Country->id}}" @selected($partnerTranslation->country_id ==
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="city" title="Choose one of the following..."
                                    ...
                                    <option value="{{$city->id}}" @selected($partnerTranslation->city_id ==
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="representative" placeholder="{{__('cms.representative')}}" value="{{$partnerTranslation->representative}}"/>
                            <span class="form-text text-muted">{{__('cms.please_enter')}} {{__('cms.representative')}}</span>
                        </div>
                    </div>
...
<script>
    function performEdit(){
        ...
        update('/cms/admin/partners/translations/{{$partnerTranslation->id}}', data, '/cms/admin/partners');
    }
</script>
@endsection
