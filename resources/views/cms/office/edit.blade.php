...
@section('page-name',__('cms.OfficeTranslation'))
@section('main-page',__('cms.OfficeTranslation'))
@section('sub-page',__('cms.OfficeTranslation '))
            ...
            <form id="create-form">
                <div class="card-body">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="language" title="Choose one of the following..."
                                    ...
                                    <option value="{{$language->id}}" @selected($OfficeTranslation->language_id ==
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="city" title="Choose one of the following..."
                                    ...
                                    <option value="{{$city->id}}" @selected($OfficeTranslation->city_id ==
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="country" title="Choose one of the following..."
                                    ...
                                    <option value="{{$country->id}}" @selected($OfficeTranslation->country_id ==
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="name" placeholder="{{__('cms.name_manger')}}"
                                value="{{$OfficeTranslation->name}}" />
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="address1" placeholder="{{__('cms.name')}}"
                                value="{{$OfficeTranslation->address1}}" />
                    ...
                    <div class="form-group row mt-4">
                        <label class="col-3 col-form-label">{{__('cms.name_manger')}}:</label>
                        <div class="col-9">
                            <input type="text" class="form-control" id="address2" placeholder="{{__('cms.name_manger')}}"
                                value="{{$OfficeTranslation->address2}}" />
                            <span class="form-text text-muted">{{__('cms.name_manger')}} {{__('cms.name_manger')}}</span>
                        </div>
                    </div>
...
<script>
    function performEdit(){
        ...
        update('/cms/admin/offices/translations/{{$OfficeTranslation->id}}', data, '/cms/admin/offices');
    }
</script>
@endsection
