...
@section('sub-page',__('cms.votequestionTranslation '))
                            ...
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="language"
                                    ...
                                    @foreach ($languages as $language)
                                        <option value="{{$language->id}}" @selected($votequestionTranslation->language_id == $language->id)>{{$language->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="title" placeholder="{{__('cms.title')}}"
                                value="{{$votequestionTranslation->title}}" />
...
<script>
    function performEdit(){
        ...
        update('/cms/admin/votequestions/translations/{{$votequestionTranslation->id}}', data, '/cms/admin/votequestions');
    }
</script>
@endsection
