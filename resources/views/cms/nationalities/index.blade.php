...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark">{{__('cms.nationality')}}</span>
            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$nationality->translations->first()?->name
                                ?? ''}}</a>
                        </td>

                        <td>
                            <a href="#" data-toggle="modal" data-target="#nationality_{{$nationality->id}}_translations"
                                class="btn btn-light-primary font-weight-bolder font-size-sm">({{$nationality->translations_count}})</a>
                            <div class="modal fade" id="nationality_{{$nationality->id}}_translations" tabindex="-1"
                                role="dialog" aria-labelledby="nationality_{{$nationality->id}}_translations"
                                aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    @foreach ($nationality->translations as $translation)
                                                    <tr>
                                                        <td>
                                                            <span
                                                        ...
                                                        <td class="pr-0 text-right">
                                                            ...
                                                            <a href="{{route('nationality-translations.edit',$translation->id)}}"
                        ...
                        <td>
                            <span
                                class="label label-lg @if($nationality->active) label-light-success @else label-light-warning @endif label-inline">{{$nationality->active_key}}</span>
                        </td>
                        <td class="pr-0 text-right">
                            @can('Create-Nationality')
                            <a href="{{route('nationality-translations.create',$nationality->id)}}"
                                class="btn btn-icon btn-light btn-hover-primary btn-sm">
                            ...
                            @endcan
                            @can('Delete-Nationality')
                            <a href="#" onclick="performCountryDestroy('{{$nationality->id}}', this)"
                                class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                <span class="svg-icon svg-icon-md svg-icon-primary">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/General/Trash.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
...
<script>
    function performCountryDestroy(id,reference) {
        confirmDestroy('/cms/admin/nationalities', id, reference);
    }
    function performTranslationDestroy(id,reference) {
        confirmDestroy('/cms/admin/nationalities/translations', id, reference);
    }
</script>
@endsection