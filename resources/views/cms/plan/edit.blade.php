            ...
            <form id="create-form">
                <div class="card-body">
                            ...
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="language"
                                    ...
                                    @foreach ($languages as $language)
                                        <option value="{{$language->id}}" @selected($planTranslation->language_id == $language->id)>{{$language->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="title" placeholder="{{__('cms.title')}}" value="{{$planTranslation->title}}"/>
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <textarea type="textarea" class="form-control" id="description" placeholder="{{__('cms.description')}}" rows="4"
                                cols="50">{{$planTranslation->description}}</textarea>
...
<script>
    function performEdit(){
        ...
        update('/cms/admin/plans/translations/{{$planTranslation->id}}', data, '/cms/admin/plans');
    }
</script>
@endsection
