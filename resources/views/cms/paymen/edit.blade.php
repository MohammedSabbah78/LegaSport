...
@section('page-name',__('cms.paymenTranslation'))
@section('main-page',__('cms.content_management'))
@section('sub-page',__('cms.paymenTranslation '))
                            ...
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="language"
                                    ...
                                    @foreach ($languages as $language)
                                        <option value="{{$language->id}}" @selected($paymenTranslation->language_id == $language->id)>{{$language->name}}</option>
                                    @endforeach
                                </select>
                            </div>
...
<script>
    function performEdit(){
        ...
        update('/cms/admin/paymens/translations/{{$paymenTranslation->id}}', data, '/cms/admin/paymens');
    }
</script>
@endsection
