...
@section('page-name',__('cms.paymen'))
@section('main-page',__('cms.content_management'))
@section('sub-page',__('cms.paymen'))
@section('page-name-small',__('cms.paymen'))
            ...
            <form id="create-form">
                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col-9">
                            <button type="button" onclick="performStore({{$paymen->id ?? null}})"
...
if(id == null) {
    ...
    store('/cms/admin/paymens/'+id+'/translation',formData, '/cms/admin/paymens');
    }
