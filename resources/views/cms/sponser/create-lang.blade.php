        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <form id="create-form">
                <div class="card-body">
                    ...
                    <div class="form-group row mt-4">
                        <label class="col-3 col-form-label">{{__('cms.partner')}}:<span class="text-danger">*</span></label>
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                    ...
                    <div class="form-group row mt-4">
                        <label class="col-3 col-form-label">{{__('cms.events')}}:<span class="text-danger">*</span></label>
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
...
if(id == null) {
    ...
    store('/cms/admin/sponsers/'+id+'/translation',formData, '/cms/admin/sponsers');
    }
