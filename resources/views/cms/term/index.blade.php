            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                <thead>
                    <tr class="text-uppercase">
                        ...
                        @canany(['Update-Term','Delete-Term'])
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$term->translations->first()?->title
                                ?? ''}}</a>
                        </td>
                        ...
                        <td>
                            <a href="#" data-toggle="modal" data-target="#sports_{{$term->id}}_translations"
                                class="btn btn-light-primary font-weight-bolder font-size-sm">({{$term->translations_count}})</a>
                            <div class="modal fade" id="sports_{{$term->id}}_translations" tabindex="-1" role="dialog"
                                aria-labelledby="sports_{{$term->id}}_translations" aria-hidden="true">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="pr-0 text-right">
                                                            @can('Update-Term')
                                                            <a href="{{route('term-translations.edit',$translation->id)}}"
                        ...
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$term->translations->first()?->body
                                ?? ''}}</a>
                        </td>
                        ...
                        <td class="pr-0 text-right">
                            @can('Create-Term')
                            <a href="{{route('term-translations.create',$term->id)}}"
                                class="btn btn-icon btn-light btn-hover-primary btn-sm">
                            ...
                            @endcan
                            @can('Delete-Term')
                            <a href="#" onclick="performSportsDestroy('{{$term->id}}', this)"
                                class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                <span class="svg-icon svg-icon-md svg-icon-primary">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/General/Trash.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
...
<script>
    function performSportsDestroy(id,reference) {
        confirmDestroy('/cms/admin/terms', id, reference);
    }
    function performTranslationDestroy(id,reference) {
        confirmDestroy('/cms/admin/terms/translations', id, reference);
    }
</script>
@endsection
