            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" data-toggle="modal" data-target="#terms_{{$term->id}}_translations"
                                class="btn btn-light-primary font-weight-bolder font-size-sm">({{$term->translations_count}})</a>
                            <div class="modal fade" id="terms_{{$term->id}}_translations" tabindex="-1" role="dialog"
                                aria-labelledby="terms_{{$term->id}}_translations" aria-hidden="true">
