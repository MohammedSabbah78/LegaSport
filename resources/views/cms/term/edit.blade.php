            ...
            <form id="create-form">
                <div class="card-body">
                            ...
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="language"
                                    ...
                                    @foreach ($languages as $language)
                                        <option value="{{$language->id}}" @selected($termTranslation->language_id == $language->id)>{{$language->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <textarea type="text" class="form-control" id="body" placeholder="{{__('cms.body')}}" rows="4"
                                cols="5">{{$termTranslation->body}}</textarea>
...
<script>
    function performEdit(){
        ...
        update('/cms/admin/terms/translations/{{$termTranslation->id}}', data, '/cms/admin/terms');
    }
</script>
@endsection
