...
@section('page-name',__('cms.offers'))
@section('main-page',__('cms.content_management'))
@section('sub-page',__('cms.offers'))
            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$offer->name
                                ?? ''}}</a>
                        </td>
                        ...
                        <td>
                            <a href="#" data-toggle="modal" data-target="#sports_{{$offer->id}}_translations"
                                class="btn btn-light-primary font-weight-bolder font-size-sm">({{$offer->translations_count}})</a>
                            <div class="modal fade" id="sports_{{$offer->id}}_translations" tabindex="-1" role="dialog"
                                aria-labelledby="sports_{{$offer->id}}_translations" aria-hidden="true">
                        ...
                        <td class="pl-0">
                            <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$offer->translations->first()?->description
                                ?? ''}}</a>
                        </td>
...
<script>
    function performSportsDestroy(id,reference) {
        confirmDestroy('/cms/admin/offers', id, reference);
    }
    function performTranslationDestroy(id,reference) {
        confirmDestroy('/cms/admin/offers/translations', id, reference);
    }
</script>
@endsection
