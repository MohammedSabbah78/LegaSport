...
@section('page-name',__('cms.offerTranslation'))
@section('main-page',__('cms.offerTranslation'))
@section('sub-page',__('cms.offerTranslation '))
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="language" title="Choose one of the following..."
                                    ...
                                    <option value="{{$language->id}}" @selected($offerTranslation->language_id ==
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="description" placeholder="{{__('cms.description')}}"
                                value="{{$offerTranslation->description}}" />
...
<script>
    function performEdit(){
        ...
        update('/cms/admin/offers/translations/{{$offerTranslation->id}}', data, '/cms/admin/offers');
    }
</script>
@endsection
