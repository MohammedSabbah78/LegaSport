            ...
            <form id="create-form">
                <div class="card-body">
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="link_website" placeholder="{{__('cms.link')}}" />
                    ...
                    <div class="separator separator-dashed my-10"></div>
                    <div class="form-group row mt-4">
                        <label class="col-3 col-form-label">{{__('cms.linkt_twiter')}}:</label>
                        <div class="col-9">
                            <input type="text" class="form-control" id="link_twitter" placeholder="{{__('cms.link')}}" />
                            <span class="form-text text-muted">{{__('cms.link')}} {{__('cms.link')}}</span>
                        </div>
                    </div>
...
formData.append('website',document.getElementById('link_website').value);
formData.append('mobile',document.getElementById('mobile').value);
formData.append('twitter',document.getElementById('link_twitter').value);
