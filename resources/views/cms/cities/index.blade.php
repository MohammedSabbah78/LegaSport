            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$city->translations->first()?->name
                                ?? ''}}</a>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <div class="modal fade" id="city_{{$city->id}}_translations" tabindex="-1" role="dialog"
                                aria-labelledby="city_{{$city->id}}_translations" aria-hidden="true">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="pr-0 text-right">
                                                            @can('Update-City')
                                                            <a href="{{route('city-translations.edit',$translation->id)}}"
                        ...
                        <td>
                            <span
                                class="label label-lg @if($city->active) label-light-success @else label-light-warning @endif label-inline">{{$city->active_key}}</span>
                        </td>
                        <td class="pr-0 text-right">
                            @can('Create-City')
                            <a href="{{route('city-translations.create',$city->id)}}"
                                class="btn btn-icon btn-light btn-hover-primary btn-sm">
...
<script>
    ...
    function performTranslationDestroy(id,reference) {
        confirmDestroy('/cms/admin/cities/translations', id, reference);
    }
</script>
@endsection